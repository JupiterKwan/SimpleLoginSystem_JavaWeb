                ...
                while ((lineData = bufferedReader.readLine()) != null) {
                    ...
                    if (detail[0].equals(username)) {
                        if (detail[1].equals(pwd)) {
                            ...
                            response.getWriter().print("<h2>基本信息：</h2>" + "<ul><li>姓名：" + detail[0] + "</li><li>性别：" + gender + "</li><li>年龄：" + detail[3] + "</li><li>邮箱：" + detail[4] + "</li><li>注册时间：" + detail[5] + "</li><li>登录次数：" + detail[6] + "</li><li>上次登录时间：" + detail[7] + "</li><li>本次登录时间：" + date + "</li></ul>");
